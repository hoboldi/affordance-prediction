"""After syn-aug training: do SEEN synonyms work (memorized) AND HELD-OUT synonyms generalize?
synaug8 fold models, held-out objects, clean GT. CPU."""
...
print(f"{'verb':9s} {'exact':>6s} {'SEEN-syn':>16s} {'HELD-OUT-syn':>18s}")
for v in SEEN:
    ex=[];se=[];he=[]
