"""FULL 5-fold: RICH-augmented vs baseline syn-aug on held-out synonyms.
Columns: exact | base-bare (current best) | RICH-bare | RICH-ensemble. CPU."""
...
def load_set(tag):
    ...
    return d
BASE=load_set("gnn_synaug8"); RICH=load_set("gnn_synaugrich8")
...
print("=== FULL 5-fold: RICH vs baseline syn-aug, held-out synonyms ===")
...
for v in HELD:
    ...
    for o in sorted(obj2fold):
        ...
        re.append(average_precision_score(y,pred(RICH,o,emb_hens[v])))
    if ex:
